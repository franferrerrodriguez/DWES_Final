        ...
        <ul class="navbar-nav">
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a class="dropdown-item" href="#"><b>Total: 166,23€</b></a>
                    <div class="dropdown-divider"></div>
                    <a class="btn btn-secondary" href="?page=shoppingCart" role="button" style="width: 100%;">Ver carrito</a>
                </div>
            </li>
            ...
            <li class="nav-item dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <div class="dropdown-divider"></div>
                    <a class="dropdown-item" href="#"><b>Cerrar sesión</a>
                </div>
            </li>
        </ul>
    </div>
